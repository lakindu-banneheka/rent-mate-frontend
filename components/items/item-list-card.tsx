        ...
        >
            <CardContent className="p-4">
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="relative w-full sm:w-1/3 h-48 sm:h-auto overflow-hidden rounded-md">
                        {item.imageUrls[0] ? (
                            <Image
                    ...
                    <div className="flex flex-col sm:w-2/3">
                        <div>
                            <h3 className="text-lg font-semibold leading-none tracking-tight">{item.name}</h3>
                            ...
                            <div className="mt-2 flex flex-wrap items-center gap-2">
                                ...
                                {deliveryOptions.map((option, index) => (
                                    <Badge key={index} variant="outline" className="text-xs gap-1">
                                        ...
                                        {option.method === DeliveryMethod.PICKUP ? 'Pickup' : `Delivery Rs.${option.cost}`}
                                    </Badge>
                                ))}
                            </div>
                        </div>
